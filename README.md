[![Version](https://img.shields.io/github/v/release/Open-CMSIS-Pack/STM32F2xx_DFP?label=Release)](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/releases/latest)
[![License: Apache-2.0](https://img.shields.io/badge/License-Apache--2.0-green?label=License)](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/blob/main/LICENSE)
[![Build pack](https://img.shields.io/github/actions/workflow/status/Open-CMSIS-Pack/STM32F2xx_DFP/pack.yml?logo=arm&logoColor=0091bd&label=Build%20pack)](./.github/workflows/pack.yml)

# STM32F2xx_DFP

This is the development repository for the **STMicroelectronics STM32F2 Series Device Family Pack (DFP)** - a CMSIS software pack that is designed to work with all compiler toolchains (Arm Compiler, GCC, IAR, LLVM). It is released as [CMSIS software pack](https://www.keil.arm.com/packs/stm32f2xx_dfp-keil) and therefore accessible by CMSIS-Pack enabled software development tools.
...
:---------------------------|:--------------
[.github/workflows](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/tree/main/.github/workflows)  | [GitHub Actions](#github-actions) for creating the software pack.
[CMSIS/Debug](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/tree/main/CMSIS/Debug)              | Contains debug configuration scripts.
[CMSIS/Flash](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/tree/main/CMSIS/Flash)              | Contains flash algorithms.
[CMSIS/SVD](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/tree/main/CMSIS/SVD)                  | Contains SVD files for the devices.
[Templates](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/tree/main/Templates)                  | Device specific project templates to start new *csolution projects*.
...
Please feel free to raise an [issue on GitHub](https://github.com/Open-CMSIS-Pack/STM32F2xx_DFP/issues)
